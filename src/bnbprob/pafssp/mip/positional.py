...
def positional_model(
    ...
    edges : List[Tuple[int, int]], optional
        Directed edges representing machine precedences, by default None
    ...
    model.cstr_precede = pyo.Constraint(model.E, model.K, rule=cstr_precede)
...
def cstr_precede(
    model: pyo.ConcreteModel, m1: int, m2: int, k: int
) -> pyo.Expression:
    return (
